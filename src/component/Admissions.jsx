...
const Admissions = () => {
    ...
    <>
      <PageTitle title="Admissions" />
            ...
            <div className="section">
                <h3>Scholarship Opportunities</h3><br />
            ...
            <div className="section">
                ...
                <div className="form-container">
                    ...
                    <form>
                        ...
                        <input type="text" id="fullName" name="fullName" className="text-input" /><br /><br />
                        ...
                        <input type="tel" id="phone" name="phone" pattern="[0-9]{10}" maxlength="10"
                            placeholder="Enter 10-digits" className="text-input" /><br /><br />

                        <label htmlFor="dob">Date of Birth*</label>
                        <input type="date" id="dob" name="dob" className="text-input" /><br /><br />

                        <label>Gender*</label>
                        <input type="radio" id="male" name="gender" className="radio-check" />
                        <label htmlFor="male" className="rc-label">Male</label>

                        <input type="radio" id="female" name="gender" className="radio-check" />
                        <label htmlFor="female" className="rc-label">Female</label>

                        <input type="radio" id="other" name="gender" className="radio-check" />
                        <label htmlFor="other" className="rc-label">Other</label>
                        ...
                        <input type="radio" id="degreeProgram" name="programType" className="radio-check"/>
                            <label htmlFor="degree program" className="rc-label">Degree Program</label>

                            <input type="radio" id="diplomaProgram" name="programType" className="radio-check"/>
                                <label htmlFor="diploma program" className="rc-label">Diploma Program</label>

                                <input type="radio" id="CertificateProgram" name="programType" className="radio-check"/>
                                    <label htmlFor="Certificate program" className="rc-label">Certificate Program</label>

                                    <label>Terms and Conditions*</label>
                                    <input type="checkbox" id="terms" name="terms" className="radio-check"/>
                                        <label htmlFor="terms" className="rc-label">I agree to the terms and conditions and confirm that all information
